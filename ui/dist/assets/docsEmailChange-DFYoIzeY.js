function m(e){const a=app.utils.getApiExampleURL(),i=[{title:"Request email change",content:o},{title:"Confirm email change",content:r}],n=store({activeActionIndex:0});return t.div({pbEvent:"apiPreviewEmailChange",className:"content"},t.p(null,`Sends ${e.name} email change request.`),t.p(null,"On successful email change all previously issued auth tokens for the specific record will be invalidated (and the user will be marked as verified if not already)."),app.components.codeBlockTabs({className:"sdk-examples m-t-sm",historyKey:"pbLastSDK",tabs:[{title:"JS SDK",language:"js",value:`
                    ...
                    `,footnote:t.div({className:"txt-right"},t.a({href:"https://github.com/pocketbase/dart-sdk",target:"_blank",rel:"noopener noreferrer",textContent:"Dart SDK docs"}))},{title:"curl",language:"bash",value:`
                        ...
                        curl -X POST \\
                          ...
                          -d '{ "newEmail":"..." }' \\
                          '${a}/api/collections/${e.name}/request-email-change'
                        ...
                        curl -X POST \\
                          -H 'Content-Type:application/json' \\
                          -d '{ "token":"...", "password":"" }' \\
                          '${a}/api/collections/${e.name}/confirm-email-change'
                    `}]}),t.nav({className:"btns m-t-base m-b-sm"},()=>i.map((s,l)=>t.button({type:"button",className:()=>`btn sm expanded ${n.activeActionIndex==l?"active":"secondary"}`,textContent:()=>s.title,onclick:()=>n.activeActionIndex=l}))),()=>{var s,l;return(l=(s=i[n.activeActionIndex])==null?void 0:s.content)==null?void 0:l.call(s,e)})}function o(e){const a=[{title:204,value:"null"},{title:400,value:`
                {
                  "status": 400,
