function r(e){const a=app.utils.getApiExampleURL(),l=e.deleteRule===null,s=[{title:204,value:"null"},{title:400,value:`
                {
                  "status": 400,
                  "message": "Failed to delete record. Make sure that the record is not part of a required relation reference.",
                  "data": {}
                }
            `}];return l&&s.push({title:403,value:`
                {
                  "status": 403,
