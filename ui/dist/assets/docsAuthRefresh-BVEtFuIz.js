import{e as o}from"./expandInfo-CTyADVsr.js";import{f as l}from"./fieldsInfo-CSZqlaEr.js";function d(e){const a=app.utils.getApiExampleURL(),s={collectionId:e.id,collectionName:e.name},r=[{title:200,value:JSON.stringify({token:"...JWT...",record:Object.assign(s,app.utils.getDummyFieldsData(e))},null,2)},{title:401,value:`
                {
                  "status": 401,
            ...
            `}];return t.div({pbEvent:"apiPreviewAuthRefresh",className:"content"},t.p(null,"Returns a new auth response (token and record data) for an already authenticated record."),t.p(null,"This method is usually called by users on page/screen reload to ensure that the previously stored data in ",t.code(null,"pb.authStore")," is still valid and up-to-date."),app.components.codeBlockTabs({className:"sdk-examples m-t-sm",historyKey:"pbLastSDK",tabs:[{title:"JS SDK",language:"js",value:`
                        ...
                        const authData = await pb.collection('${e.name}').authRefresh();
                    ...
                    `,footnote:t.div({className:"txt-right"},t.a({href:"https://github.com/pocketbase/js-sdk",target:"_blank",rel:"noopener noreferrer",textContent:"JS SDK docs"}))},{title:"Dart SDK",language:"dart",value:`
                        ...
                        final authData = await pb.collection('${e.name}').authRefresh();
                    ...
                    `,footnote:t.div({className:"txt-right"},t.a({href:"https://github.com/pocketbase/dart-sdk",target:"_blank",rel:"noopener noreferrer",textContent:"Dart SDK docs"}))},{title:"curl",language:"bash",value:`
                        curl -X POST \\
                          ...
                          '${a}/api/collections/${e.name}/auth-refresh'
                    `}]}),t.div({className:"m-t-base"},t.strong(null,"API details")),t.div({className:"alert success api-preview-alert"},t.span({className:"label method"},"POST"),t.span({className:"path"},`/api/collections/${e.name}/auth-refresh`),t.small({className:"extra"},"Requires",t.br(),"Authorization:TOKEN header")),t.table({className:"api-preview-table query-params"},t.thead(null,t.tr(null,t.th({className:"min-width txt-primary"},"?query params"),t.th({className:"min-width"},"Type"),t.th(null,"Description"))),t.tbody(null,t.tr(null,t.td({className:"min-width"},"expand"),t.td({className:"min-width"},t.span({className:"label"},"String")),t.td(null,o())),t.tr(null,t.td({className:"min-width"},"fields"),t.td({className:"min-width"},t.span({className:"label"},"String")),t.td(null,l())))),t.div({className:"m-t-base m-b-sm"},t.strong(null,"Example responses")),app.components.codeBlockTabs({tabs:r}))}export{d as docsAuthRefresh};
